...
<meta name="copyright" content="All Rights Reserved, Copyright (C) 2019, 杰KaMi, Ltd." />
<title>后台管理主页</title>
...
<script>
    ...
    function closes() {
    	...
    	console.log("secondMenuList: " + "${secondMenuList }");
...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:6%;">
	...
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; 2019 【杰KaMi】 All Rights Reserved
    </div>
    <!-- end of footer -->  
