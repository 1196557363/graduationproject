	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td valign="middle">
                	<img id="preview-photo" style="float:left;" src="${pagecontext.request.contextPath }/resources/easyui/images/user_photo.jpg" width="100px">
            ...
            <tr>
                ...
                <td><input type="text" id="add-photo" name="photo" value="/wpjEcProject/WebContent/resources/easyui/images/user_photo.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
            <tr>
	...
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'photo',title:'用户头像',width:100,align:'center',formatter:function(value,row,index){
				var img = '<img src="'+value+'" width="50px" style="padding-top:2px;" />';
				return img;
			}},
